...
var _MovieRowTemplate = require('./MovieRowTemplate');

var _MovieRowTemplate2 = _interopRequireDefault(_MovieRowTemplate);
...
var API_KEY = '1aee93b115858a448cb83ef53b33f6fa';
var BASE_URI = 'http://api.themoviedb.org/3/search/movie?api_key=' + API_KEY;

var apiClient = new _ApiClient2.default({
    BASE_URI: BASE_URI,
    IMAGES_URI: IMAGES_URI
});
var template = new _MovieRowTemplate2.default();
var view = new _AppView2.default(template);

// initialize the app
(0, _utils.$on)(window, 'load', function () {
    view.onSearch(function () {
        var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(searchTerm) {
            var response, movies;
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.prev = 1;
                            _context.next = 4;
                            return apiClient.fetch({ searchTerm: searchTerm });
...
},{"core-js/fn/regexp/escape":9,"core-js/shim":302,"regenerator-runtime/runtime":303}],8:[function(require,module,exports){
"use strict";
